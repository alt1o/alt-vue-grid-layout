...
/* harmony default export */ var gridvue_type_script_lang_js_ = ({
  ...
  methods: {
    bindEvents: function bindEvents() {
      ...
      this.eventHandler.mouseup = this.mouseup.bind(this); // this.$el.addEventListener('mousedown', this.eventHandler.mousedown);
...
var GridLayoutvue_type_script_lang_js_Vue = getVue();
...
/* harmony default export */ var GridLayoutvue_type_script_lang_js_ = ({
  ...
  created: function created() {
    ...
    self._provided.eventBus = new GridLayoutvue_type_script_lang_js_Vue();
